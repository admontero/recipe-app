<x-app-layout>
    ...
    <x-breadcrumbs>
        ...
        <li class="breadcrumb-item active" aria-current="page">{{ __('modules.recipe.edit.header') }}</li>
    </x-breadcrumbs>

    <x-form-section method="post" action="{{ route('back.recipes.update', $recipe) }}" id="recipeForm" enctype="multipart/form-data">
        <x-slot name="title">
            {{ __('modules.recipe.edit.title') }}
        </x-slot>

        <x-slot name="description">
            {{ __('modules.recipe.edit.description') }}
        </x-slot>
