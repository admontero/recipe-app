<x-app-layout>
    ...
    <x-breadcrumbs>
        ...
        <li class="breadcrumb-item active" aria-current="page">{{ __('recipe.create.header') }}</li>
    </x-breadcrumbs>

    <x-form-section method="post" action="{{ route('recipes.store') }}" id="recipeForm" enctype="multipart/form-data">
        <x-slot name="title">
            {{ __('recipe.create.title') }}
        </x-slot>

        <x-slot name="description">
            {{ __('recipe.create.description') }}
        </x-slot>
