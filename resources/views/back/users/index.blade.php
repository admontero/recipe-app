    ...
    <x-slot name="header">
        <div class="d-flex justify-content-between align-items-center">
            <h2 class="h4 font-weight-bold">
                {{ __('modules.user.index.header') }}
            </h2>
            <a href="{{ route('back.users.create') }}" class="btn btn-sm btn-success">{{ __('modules.user.create.title') }}</a>
        </div>
    </x-slot>

    <x-breadcrumbs>
        <li class="breadcrumb-item">{{ __('modules.user.index.header') }}</li>
    </x-breadcrumbs>

    <x-table-section>
        <x-slot name="title">
            {{ __('modules.user.index.title') }}
        </x-slot>

        <x-slot name="description">
            {{ __('modules.user.index.description') }}
        </x-slot>
