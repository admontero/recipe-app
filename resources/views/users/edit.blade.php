<x-app-layout>
    ...
    <x-breadcrumbs>
        ...
        <li class="breadcrumb-item active" aria-current="page">{{ __('user.edit.header') }}</li>
    </x-breadcrumbs>

    <x-form-section method="post" action="{{ route('users.update', $user) }}">
        <x-slot name="title">
            {{ __('user.edit.title') }}
        </x-slot>

        <x-slot name="description">
            {{ __('user.edit.description') }}
        </x-slot>
