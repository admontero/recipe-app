<x-app-layout>
    ...
    <x-breadcrumbs>
        ...
        <li class="breadcrumb-item active" aria-current="page">{{ __('modules.user.create.header') }}</li>
    </x-breadcrumbs>

    <x-form-section method="post" action="{{ route('back.users.store') }}">
        <x-slot name="title">
            {{ __('modules.user.create.title') }}
        </x-slot>

        <x-slot name="description">
            {{ __('modules.user.create.description') }}
        </x-slot>
